...
public class BridgeHelper extends Object {
	...
	public BridgeHelper(Context aCtx, LinearLayout aLinearLayoutMain, WebView aWebView, Handler aHandler) {
		super();
...
//		ViewGroup.MarginLayoutParams params = (MarginLayoutParams) myButton.getLayoutParams();
